...
const AsterAIPreview = () => {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-purple-500/20 bg-gray-900 p-6 md:p-8">
        <div className="grid items-center gap-6 md:gap-12 lg:grid-cols-2">
          ...
          <div>
            <div className="mb-4 md:mb-6 flex items-center gap-2">
              ...
              <h2 className="text-3xl md:text-4xl font-semibold">Meet Aster AI</h2>
            </div>
            ...
            <motion.button
              className="z-50 mt-4 md:mt-6 inline-flex items-center rounded-lg bg-purple-600 px-5 py-3 md:px-6 text-sm md:text-base transition-colors hover:bg-purple-700"
          ...
          <div className="rounded-xl border border-purple-500/20 bg-gray-950 p-4 md:p-6">
            <div className="space-y-4">
              {/* Chat Header */}
              <div className="mb-3 md:mb-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 animate-pulse rounded-full bg-green-400" />
                  <span className="text-sm text-gray-400">Aster AI is ready to assist</span>
                </div>
              </div>
              ...
              >
                <div className="max-w-[80%] flex-1 rounded-lg bg-gray-900 p-3 md:p-4 text-sm md:text-base">
              ...
              >
                ...
                <div className="max-w-[80%] flex-1 rounded-lg bg-purple-500/10 p-3 md:p-4 text-sm md:text-base text-purple-200">
              ...
              >
                ...
                <div className="flex-1 rounded-lg bg-blue-500/10 p-3 md:p-4 text-sm md:text-base text-blue-200">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <div className="flex-1 rounded-lg bg-gray-900 p-3 md:p-4">
              ...
              >
                ...
                <div className="flex-1">
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                    className="mb-4 rounded-lg bg-green-500/10 p-3 md:p-4 text-sm md:text-base text-green-200"
                  >
                  ...
                  <motion.div
                    ...
                    className="rounded-lg bg-purple-500/10 p-3 md:p-4 text-sm md:text-base text-purple-200"
                  >
                    <TypingAnimation text="I've created the authentication system task and assigned it to David. The task has been prioritized for the next sprint." />
                  </motion.div>
                </div>
              </motion.div>
        ...
        <motion.div
          className="absolute -bottom-16 -right-16 h-32 w-32 md:h-40 md:w-40 rounded-full bg-purple-500/30 blur-3xl"
